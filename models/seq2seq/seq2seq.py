...
if __name__ == "__main__":
    ...
    # train(encdecmodel=encdecmodel, steps_per_epoch=35, epochs=5, validation_data=(test_x_batches, test_y_batches),
    #       learning_rate=0.00075, plot_yscale='linear', load_weights_path="l0.00075-ss32-tl0.467-vl0.459-i96-o96-e20-seq2seq.h5", intermediates=4)

    encdecmodel.load_weights(filepath="l0.00075-ss32-tl0.454-vl0.449-i96-o96-e20-seq2seq.h5")
