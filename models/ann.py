        ...
        for i in range(self.intermediates):
            try:
                ...
                self.model.save_weights(
                    "ann-l{0}-ss{1}-tl{2:.3f}-vl{3:.3f}-i{4}-o{5}-seq2seq.h5".format(str(self.learning_rate),
                                                                                     str(self.state_size),
                ...
                self.model.save_weights(
                    "ann-l{0}-ss{1}-interrupted-i{2}-o{3}-seq2seq.h5".format(str(self.learning_rate),
                                                                             str(self.state_size),
                                                                             self.seq_len_in,
                                                                             self.seq_len_out))
